function [data, prefs]=colorOrient_estTask_Harry_test(prefs, saveFileName,edfFile,subStr, block,condition,sumScore)
        ...
        if prefs.taskType~=0
            ...
            if prefs.doPredict && trialIndex < prefs.nTrials
                ...
                for i=1:prefs.nItems
                    ...
                    allPredStartPoint(trialIndex) = startPoint;
